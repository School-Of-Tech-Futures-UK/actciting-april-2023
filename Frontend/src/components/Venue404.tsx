...
const Venue404 = () => {
    return (
            <div className="cover-container bg-dark d-flex w-100 h-100 mx-auto flex-column">
                <Navbar/>
                <div className="p-5 h-100 d-flex justify-content-center align-items-center">
                    <div>
                        <svg fill="#ff8000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="500" height="500" viewBox="0 0 483.095 483.095"><g><g><path d="M377.6,125.398c8.051-7.326,18.943-9.081,27.078-4.883l1.56-1.553c4.904-12.028,13.757-25.333,26.031-37.604
                        ...
                        L377.6,125.398z"></path></g></g></svg>
                        <h1 className="fs-1 fw-bold pt-3 text-light">404 Not Found</h1>
                        <h3 className="fs-4 pb-3 text-light">Cannot find Venue</h3>
                    </div>
                </div>
                <Footer/>   
            </div>
